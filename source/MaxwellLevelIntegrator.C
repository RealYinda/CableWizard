 ...
 * 构造函数.
 *************************************************************************/
MaxwellLevelIntegrator::MaxwellLevelIntegrator(const string& object_name,
        ...
        tbox::Pointer<algs::IntegratorComponentManager<NDIM> > manager)
{
  ...
  d_num_intc["INIT_AMSVAR"] = new algs::NumericalIntegratorComponent<NDIM>(
      "INIT_AMSVAR", d_patch_strategy, manager);
 ...
 ************************************************************************/
double MaxwellLevelIntegrator::getLevelDt(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
 ...
 * 向前积分一个时间步.
 ************************************************************************/
int MaxwellLevelIntegrator::advanceLevel(
                const tbox::Pointer< hier::BasePatchLevel<NDIM> > level, 
